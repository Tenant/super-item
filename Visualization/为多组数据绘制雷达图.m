...
data1 = [4.24 3.54 6.92 6.41 5.57 5.73];
data2 = [10.00 1.00 9.03 7.51 8.41 7.66];
lim = [0, 10; 0, 10; 0, 10; 0, 10; 0, 10; 0, 10];
labels = {'GPS定位复杂度', '光照条件复杂度', '环境结构化信息复杂度', '道路结构复杂度', '地形障碍复杂度', '动态目标复杂度'};

figure; hold on
Draw_radar(data1,lim,labels, 'b-', 1)
Draw_radar(data2,lim,labels, 'r-', 0)

function [H] = Draw_radar(data,lim,labels,linestyle, need_fill)
